...
console.log(sphere2);
// const b = new THREE.Vector3( 13,14,15);
// const d = sphere2.distanceTo( b );

// const posx = sphere2.position.x
// posx = 10 
...
const tick = () =>
{
    ...
    ghost3.position.x = Math.cos(ghost3Angle) * (2 + Math.sin(elapsedTime * 2.5))
    ghost3.position.z = Math.sin(ghost3Angle) + Math.sin(elapsedTime * 2.5)
